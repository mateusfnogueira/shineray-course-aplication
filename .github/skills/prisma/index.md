---
name: prisma
description: Convenções Prisma ORM para o MareApp — isolamento multi-tenant, audit log, UUID v7
type: skill
---
...
- Usar **UUID v7** para todos os IDs expostos externamente (`id` em todos os modelos públicos)
- UUID v7 é ordenado por tempo — evitar IDs sequenciais (enumeração) e aleatórios puros (sem ordenação)
